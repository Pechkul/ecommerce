...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'הסניף שלך אינו מופעל.',
        ...
        'return' => [
            'create-success'              => 'החזר נוצר בהצלחה',
            'creation-error'              => 'אין אפשרות ליצור החזר.',
            'invalid-qty'                 => 'נמצאה כמות לא חוקית לחיוב פריטים.',
            'invalid-refund-amount-error' => 'סכום ההחזר חייב להיות שונה מאפס.',
            'refund-limit-error'          => 'לא ניתן לעבד החזר בסך :amount.',
        ],
        ...
        'sales' => [
            'orders' => [
                'view' => [
                    ...
                    'note-not-available' => 'הערה אינה זמינה!',
                ],
            ],
        ],
    ...
    'seeders' => [
        'configurations' => [
            'heading-on-login'     => 'באגיסטו קופה',
            'sub-heading-on-login' => 'התחברות',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkul אינה מאשרת למוכרים צד ג\' למכור מחדש את המודולים שלה.</a>',
            'footer-note'          => '© זכויות יוצרים 2010-2023, Webkul Software (רשום בהודו/ארה"ב). כל הזכויות שמורות.',
        ],
    ],
];
