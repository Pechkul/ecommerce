...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'خروجی شما فعال نشده است.',
        ...
        'return' => [
            ...
            'invalid-qty'                 => 'تعداد نامعتبری برای صورتحساب اقلام یافت شد.',
            'invalid-refund-amount-error' => 'مقدار بازپرداخت باید بیشتر از صفر باشد.',
            'refund-limit-error'          => 'مقدار بازپرداخت :amount قابل انجام نیست.',
        ],
        ...
        'sales' => [
            'orders' => [
                'view' => [
                    ...
                    'note-not-available' => 'یادداشت در دسترس نیست!',
                ],
            ],
        ],
    ...
    'seeders' => [
        'configurations' => [
            'heading-on-login'     => 'فروشگاه Bagisto',
            'sub-heading-on-login' => 'ورود',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkul به هیچ فروشنده شخص ثالثی اجازه فروش مجدد ماژول‌های خود را نمی‌دهد.</a>',
            'footer-note'          => '© حق نشر 2010-2023، نرم‌افزار Webkul (ثبت شده در هند/آمریکا). کلیه حقوق محفوظ است.',
        ],
    ],
];
