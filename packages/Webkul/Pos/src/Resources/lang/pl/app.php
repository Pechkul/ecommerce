...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'Twój punkt sprzedaży nie jest aktywowany.',
        ...
        'return' => [
            ...
            'creation-error'              => 'Tworzenie zwrotu nie jest dozwolone.',
            'invalid-qty'                 => 'Znaleziono nieprawidłową ilość do fakturowania przedmiotów.',
            'invalid-refund-amount-error' => 'Kwota zwrotu musi być większa niż zero.',
            'refund-limit-error'          => 'Kwota zwrotu :amount nie może zostać przetworzona.',
        ],
        ...
        'sales' => [
            'orders' => [
                'view' => [
                    ...
                    'note-not-available' => 'Notatka niedostępna!',
                ],
            ],
        ],
    ...
    'seeders' => [
        'configurations' => [
            ...
            'sub-heading-on-login' => 'Zaloguj się',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkul nie upoważnia żadnych zewnętrznych sprzedawców do odsprzedaży modułów Webkul.</a>',
            'footer-note'          => '© Copyright 2010-2023, Webkul Software (Zarejestrowany w Indiach/USA). Wszelkie prawa zastrzeżone.',
        ],
    ],
];
