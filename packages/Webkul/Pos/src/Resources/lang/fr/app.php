...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'Votre point de vente n’est pas activé.',
        ...
        'return' => [
            ...
            'creation-error'              => 'La création du remboursement n’est pas autorisée.',
            'invalid-qty'                 => 'Quantité invalide trouvée pour facturer les articles.',
            'invalid-refund-amount-error' => 'Le montant du remboursement doit être supérieur à zéro.',
        ...
        'sales' => [
            'orders' => [
                'view' => [
                    ...
                    'note-not-available' => 'Note non disponible !',
                ],
            ],
        ],
    ...
    'seeders' => [
        'configurations' => [
            ...
            'sub-heading-on-login' => 'Connexion',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkul n’autorise aucun revendeur tiers à revendre les modules Webkul.</a>',
            'footer-note'          => '© Copyright 2010-2023, Webkul Software (Enregistré en Inde/USA). Tous droits réservés.',
        ],
    ],
];
