...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'Вашу торгову точку не активовано.',
        ...
        'return' => [
            ...
            'creation-error'              => 'Створення повернення заборонено.',
            'invalid-qty'                 => 'Знайдено недійсну кількість для виставлення рахунку.',
            'invalid-refund-amount-error' => 'Сума повернення повинна бути більшою за нуль.',
            'refund-limit-error'          => 'Сума повернення :amount не може бути оброблена.',
        ],
        ...
        'sales' => [
            'orders' => [
                'view' => [
                    ...
                    'note-not-available' => 'Примітка недоступна!',
                ],
            ],
        ],
    ...
    'seeders' => [
        'configurations' => [
            ...
            'sub-heading-on-login' => 'Увійти',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkul не дозволяє стороннім продавцям перепродавати модулі Webkul.</a>',
            'footer-note'          => '© Авторське право 2010-2023, Webkul Software (Зареєстровано в Індії/США). Всі права захищені.',
        ],
    ],
];
