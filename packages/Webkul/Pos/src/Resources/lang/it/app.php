...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'Il tuo punto vendita non è attivato.',
        ...
        'return' => [
            ...
            'creation-error'              => 'La creazione del rimborso non è consentita.',
            'invalid-qty'                 => 'Abbiamo trovato una quantità non valida per fatturare gli articoli.',
            'invalid-refund-amount-error' => 'L’importo del rimborso deve essere maggiore di zero.',
    ...
    'admin' => [
        'sales' => [
            'orders' => [
                'view' => [
                    'order-note'         => 'Nota dell\'ordine',
                    'note-not-available' => 'Nota non disponibile!',
                ],
            ],
        ],
    ...
    'seeders' => [
        'configurations' => [
            ...
            'sub-heading-on-login' => 'Accesso',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkul non autorizza nessun venditore di terze parti a rivendere i moduli Webkul.</a>',
            'footer-note'          => '© Copyright 2010-2023, Webkul Software (Registrato in India/USA). Tutti i diritti riservati.',
        ],
    ],
];
