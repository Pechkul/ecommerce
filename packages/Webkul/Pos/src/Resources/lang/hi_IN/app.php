...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'आपका आउटलेट सक्रिय नहीं है।',
        ...
        'return' => [
            'create-success'              => 'रिफंड सफलतापूर्वक बनाया गया',
            'creation-error'              => 'रिफंड बनाना अनुमत नहीं है।',
            'invalid-qty'                 => 'हमने आइटम को इनवॉइस करने के लिए अमान्य मात्रा पाई है।',
            'invalid-refund-amount-error' => 'रिफंड राशि शून्य से अधिक होनी चाहिए।',
            'refund-limit-error'          => 'रिफंड राशि :amount को प्रोसेस नहीं किया जा सकता।',
        ],
    ...
    'admin' => [
        'sales' => [
            'orders' => [
                'view' => [
                    'order-note'         => 'ऑर्डर नोट',
                    'note-not-available' => 'नोट उपलब्ध नहीं है!',
                ],
            ],
        ],
    ...
    'seeders' => [
        'configurations' => [
            'heading-on-login'     => 'बैगिस्टो पीओएस',
            'sub-heading-on-login' => 'लॉगिन करें',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkul किसी तीसरे पक्ष के विक्रेता को Webkul मॉड्यूल को पुनः बेचने की अनुमति नहीं देता है।</a>',
            'footer-note'          => '© कॉपीराइट 2010-2023, Webkul Software (भारत/यूएसए में पंजीकृत)। सर्वाधिकार सुरक्षित।',
        ],
    ],
];
