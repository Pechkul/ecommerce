...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'منفذك غير مُفعّل.',
        ...
        'return' => [
            'create-success'              => 'تم إنشاء المبلغ المسترد بنجاح',
            'creation-error'              => 'غير مسموح بإنشاء المبلغ المسترد.',
            'invalid-qty'                 => 'وجدنا كمية غير صالحة لفوترة العناصر.',
            'invalid-refund-amount-error' => 'يجب أن يكون مبلغ الاسترداد أكبر من صفر.',
            'refund-limit-error'          => 'لا يمكن تنفيذ مبلغ الاسترداد :amount.',
        ],
        ...
        'sales' => [
            'orders' => [
                'view' => [
                    ...
                    'note-not-available' => 'الملاحظة غير متوفرة!',
                ],
            ],
        ],
    ...
    'seeders' => [
        'configurations' => [
            'heading-on-login'     => 'بيجيستو نقاط البيع',
            'sub-heading-on-login' => 'تسجيل الدخول',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">لا تسمح Webkul لأي بائعين من أطراف ثالثة بإعادة بيع وحدات Webkul.</a>',
            'footer-note'          => '© حقوق النشر 2010-2023، Webkul Software (مسجلة في الهند/الولايات المتحدة الأمريكية). جميع الحقوق محفوظة.',
        ],
    ],
];
