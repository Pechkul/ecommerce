...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'আপনার আউটলেট সক্রিয় নয়।',
        ...
        'return' => [
            'create-success'              => 'রিফান্ড সফলভাবে তৈরি হয়েছে',
            'creation-error'              => 'রিফান্ড তৈরি অনুমোদিত নয়।',
            'invalid-qty'                 => 'আমরা একটি অবৈধ পরিমাণ পেয়েছি ইনভয়েস আইটেমের জন্য।',
            'invalid-refund-amount-error' => 'রিফান্ডের পরিমাণ শূন্যের বেশি হওয়া উচিত।',
            'refund-limit-error'          => 'রিফান্ডের পরিমাণ :amount প্রক্রিয়াজাত করা যায় না।',
        ],
        ...
        'sales' => [
            'orders' => [
                'view' => [
                    ...
                    'note-not-available' => 'নোট উপলব্ধ নয়!',
                ],
            ],
        ],
    ...
    'seeders' => [
        'configurations' => [
            'heading-on-login'     => 'ব্যাগিস্টো পিওএস',
            'sub-heading-on-login' => 'লগইন করুন',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkul কোনো তৃতীয় পক্ষের বিক্রেতাকে Webkul মডিউল পুনরায় বিক্রি করার অনুমতি দেয় না।</a>',
            'footer-note'          => '© কপিরাইট 2010-2023, Webkul Software (ভারত/যুক্তরাষ্ট্রে নিবন্ধিত)। সর্বস্বত্ব সংরক্ষিত।',
        ],
    ],
];
