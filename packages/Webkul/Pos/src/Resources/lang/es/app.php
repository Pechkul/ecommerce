...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'Tu establecimiento no está activado.',
        ...
        'return' => [
            ...
            'creation-error'              => 'No se permite la creación del reembolso.',
            'invalid-qty'                 => 'Se encontró una cantidad inválida para facturar los artículos.',
            'invalid-refund-amount-error' => 'El monto del reembolso debe ser mayor que cero.',
            'refund-limit-error'          => 'No se puede procesar el monto del reembolso :amount.',
        ],
    ...
    'seeders' => [
        'configurations' => [
            ...
            'sub-heading-on-login' => 'Iniciar sesión',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkul no autoriza a terceros a revender los módulos de Webkul.</a>',
            'footer-note'          => '© Copyright 2010-2023, Webkul Software (Registrado en India/EE.UU.). Todos los derechos reservados.',
        ],
    ],
];
