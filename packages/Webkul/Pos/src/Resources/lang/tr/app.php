...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'Şubeniz etkinleştirilmemiş.',
        ...
        'return' => [
            ...
            'creation-error'              => 'İade oluşturma izni yok.',
            'invalid-qty'                 => 'Faturalandırılacak ürünlerde geçersiz miktar bulundu.',
            'invalid-refund-amount-error' => 'İade tutarı sıfırdan büyük olmalıdır.',
            'refund-limit-error'          => 'İade tutarı :amount işlenemez.',
        ],
        ...
        'sales' => [
            'orders' => [
                'view' => [
                    ...
                    'note-not-available' => 'Not mevcut değil!',
                ],
            ],
        ],
    ...
    'seeders' => [
        'configurations' => [
            ...
            'sub-heading-on-login' => 'Giriş Yap',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkul, üçüncü taraf satıcıların Webkul modüllerini yeniden satmasına izin vermez.</a>',
            'footer-note'          => '© Telif Hakkı 2010-2023, Webkul Software (Hindistan/ABD’de kayıtlıdır). Tüm hakları saklıdır.',
        ],
    ],
];
