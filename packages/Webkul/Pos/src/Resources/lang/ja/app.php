...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'あなたの店舗は有効化されていません。',
        ...
        'return' => [
            ...
            'creation-error'              => '返金の作成は許可されていません。',
            'invalid-qty'                 => '請求する商品の数量が無効です。',
            'invalid-refund-amount-error' => '返金金額はゼロ以上でなければなりません。',
    ...
    'seeders' => [
        'configurations' => [
            ...
            'sub-heading-on-login' => 'ログイン',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkulは、サードパーティの販売者によるWebkulモジュールの再販を許可していません。</a>',
            'footer-note'          => '© 著作権 2010-2023, Webkul Software（インド／米国に登録）。無断転載を禁じます。',
        ],
    ],
];
