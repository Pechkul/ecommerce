...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'Seu estabelecimento não está ativado.',
        ...
        'return' => [
            ...
            'creation-error'              => 'A criação de reembolso não é permitida.',
            'invalid-qty'                 => 'Quantidade inválida encontrada para faturar itens.',
            'invalid-refund-amount-error' => 'O valor do reembolso deve ser maior que zero.',
        ...
        'sales' => [
            'orders' => [
                'view' => [
                    ...
                    'note-not-available' => 'Nota não disponível!',
                ],
            ],
        ],
    ...
    'seeders' => [
        'configurations' => [
            'heading-on-login'     => 'Bagisto PDV',
            'sub-heading-on-login' => 'Entrar',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">A Webkul não autoriza terceiros a revender os módulos da Webkul.</a>',
            'footer-note'          => '© Copyright 2010-2023, Webkul Software (Registrado na Índia/EUA). Todos os direitos reservados.',
        ],
    ],
];
