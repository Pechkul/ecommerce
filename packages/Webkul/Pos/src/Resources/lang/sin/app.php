...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'ඔබගේ අලෙවි ස්ථානය සක්‍රීය කර නොමැත.',
        ...
        'return' => [
            'create-success'              => 'ප්‍රතිලාභය සාර්ථකව නිර්මාණය කරන ලදී',
            'creation-error'              => 'ප්‍රතිලාභ නිර්මාණය කිරීමට ඉඩ නොදෙයි.',
            'invalid-qty'                 => 'අයිතම බිල් කිරීම සඳහා වලංගු නොවන ප්‍රමාණයක් හමු විය.',
            'invalid-refund-amount-error' => 'ප්‍රතිලාභ මුදල ශූන්‍ය නොවිය යුතුය.',
            'refund-limit-error'          => 'ප්‍රතිලාභ මුදල :amount ක් සැකසිය නොහැක.',
        ],
        ...
        'sales' => [
            'orders' => [
                'view' => [
                    ...
                    'note-not-available' => 'සටහන ලබා ගත නොහැක!',
                ],
            ],
        ],
    ...
    'seeders' => [
        'configurations' => [
            'heading-on-login'     => 'Bagisto POS',
            'sub-heading-on-login' => 'ඇතුල්වන්න',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkul විසින් තෙවන පාර්ශව වෙළෙන්දෙකුට Webkul මොඩියුල නැවත විකුණන ලෙස බලපත්‍ර නොදෙන අතර.</a>',
            'footer-note'          => '© මුල්පිරිනැමීම 2010-2023, Webkul Software (ඉන්දියාව/ඇමරිකාවේ ලියාපදිංචි). සියලුම හිමිකම් ඇවිරිණි.',
        ],
    ],
];
