...
return [
    'outlet' => [
        ...
        'return' => [
            ...
            'invalid-qty'                 => '发现无效的商品数量用于开票。',
            'invalid-refund-amount-error' => '退款金额必须大于零。',
            'refund-limit-error'          => '退款金额 :amount 无法处理。',
        ],
    ...
    'seeders' => [
        'configurations' => [
            'heading-on-login'     => 'Bagisto POS 收银系统',
            'sub-heading-on-login' => '登录',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkul 不授权任何第三方卖家转售 Webkul 模块。</a>',
            'footer-note'          => '© 版权所有 2010-2023，Webkul 软件公司（注册于印度/美国）。保留所有权利。',
        ],
    ],
];
