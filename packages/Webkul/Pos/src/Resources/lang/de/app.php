...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'Ihre Filiale ist nicht aktiviert.',
        ...
        'return' => [
            ...
            'creation-error'              => 'Erstellung der Rückerstattung ist nicht erlaubt.',
            'invalid-qty'                 => 'Ungültige Menge zum Fakturieren der Artikel gefunden.',
            'invalid-refund-amount-error' => 'Der Rückerstattungsbetrag muss größer als null sein.',
        ...
        'sales' => [
            'orders' => [
                'view' => [
                    ...
                    'note-not-available' => 'Notiz nicht verfügbar!',
                ],
            ],
        ],
    ...
    'seeders' => [
        'configurations' => [
            ...
            'sub-heading-on-login' => 'Anmelden',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkul autorisiert keine Drittverkäufer zur Weiterveräußerung von Webkul-Modulen.</a>',
            'footer-note'          => '© Copyright 2010-2023, Webkul Software (Registriert in Indien/USA). Alle Rechte vorbehalten.',
        ],
    ],
];
