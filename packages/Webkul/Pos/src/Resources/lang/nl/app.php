...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'Uw vestiging is niet geactiveerd.',
        ...
        'return' => [
            ...
            'creation-error'              => 'Terugbetaling aanmaken is niet toegestaan.',
            'invalid-qty'                 => 'Ongeldig aantal voor facturatie van artikelen gevonden.',
            'invalid-refund-amount-error' => 'Het terug te betalen bedrag moet groter dan nul zijn.',
            'refund-limit-error'          => 'Terugbetalingsbedrag :amount kan niet worden verwerkt.',
        ],
        ...
        'sales' => [
            'orders' => [
                'view' => [
                    ...
                    'note-not-available' => 'Notitie niet beschikbaar!',
                ],
            ],
        ],
    ...
    'seeders' => [
        'configurations' => [
            ...
            'sub-heading-on-login' => 'Inloggen',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkul staat geen wederverkoop van haar modules door derden toe.</a>',
            'footer-note'          => '© Copyright 2010-2023, Webkul Software (Geregistreerd in India/VSA). Alle rechten voorbehouden.',
        ],
    ],
];
