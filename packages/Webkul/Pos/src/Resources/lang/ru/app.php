...
return [
    'outlet' => [
        'agents' => [
            'login' => [
                ...
                'outlet-not-activated' => 'Ваша торговая точка не активирована.',
        ...
        'return' => [
            ...
            'invalid-qty'                 => 'Обнаружено недопустимое количество для выставления счета.',
            'invalid-refund-amount-error' => 'Сумма возврата должна быть больше нуля.',
            'refund-limit-error'          => 'Сумма возврата :amount не может быть обработана.',
        ],
        ...
        'sales' => [
            'orders' => [
                'view' => [
                    ...
                    'note-not-available' => 'Примечание недоступно!',
                ],
            ],
        ],
    ...
    'seeders' => [
        'configurations' => [
            ...
            'sub-heading-on-login' => 'Войти',
            'footer-content'       => '<a href="https://webkul.com/disclaimer/" target="_blank" class="underline">Webkul не разрешает сторонним продавцам перепродавать модули Webkul.</a>',
            'footer-note'          => '© Авторские права 2010-2023, Webkul Software (Зарегистрировано в Индии/США). Все права защищены.',
        ],
    ],
];
