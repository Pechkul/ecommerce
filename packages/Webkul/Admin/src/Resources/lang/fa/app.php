...
return [
            ...
            'create' => [
                ...
                'cart' => [
                    ...
                    'address' => [
                        ...
                        'address-updated-payment-info' => 'روش‌های پرداخت و مبلغ کل سفارش برای آدرس تغییریافته به‌روزرسانی می‌شوند. برای بارگذاری جدیدترین گزینه‌ها روی «ادامه» کلیک کنید.',
                        'address-updated-shipping-info' => 'روش‌ها و هزینه‌های ارسال برای آدرس تغییریافته دوباره محاسبه می‌شوند. برای بارگذاری جدیدترین گزینه‌ها روی «ادامه» کلیک کنید.',
                        'address-updated-title' => 'آدرس به‌روزرسانی شد',
                        'addresses' => 'آدرس‌ها',
                        'back' => 'بازگشت',
    ...
    'marketing' => [
        ...
        'promotions' => [
            ...
            'catalog-rules' => [
                ...
                'queue-note' => 'ذخیره این قانون، قیمت همه محصولاتی را که شامل آن‌ها می‌شود به‌روزرسانی می‌کند. اگر شامل محصولات زیادی می‌شود، از درایور صف database یا redis همراه با یک پردازشگر صف در حال اجرا استفاده کنید تا قیمت‌ها به‌جای کند کردن ذخیره، در پس‌زمینه به‌روزرسانی شوند.',
    ...
    'appearance' => [
        ...
        'sections' => [
            'index' => [
                ...
                'inactive-theme' => 'فقط قالبی که در یک کانال فعال است قابل سفارشی‌سازی است.',
                'locale' => 'زبان',
                'mobile' => 'موبایل',
                'no-fields' => 'این بخش در این قالب تنظیماتی برای ویرایش ندارد.',
                'no-types' => 'این قالب هیچ نوع بخشی برای افزودن ارائه نمی‌دهد.',
            ...
            'create' => [
                'name' => 'نام',
                'save-btn' => 'ذخیره بخش',
                'singleton-exists' => 'این کانال تنها یک بخش :type را نمایش می‌دهد.',
                'title' => 'ایجاد بخش',
    ...
    'settings' => [
        ...
        'users' => [
            ...
            'role-not-grantable' => 'نمی‌توانید نقشی با مجوزهایی که خودتان ندارید اختصاص دهید.',
            'update-success' => 'کاربر با موفقیت به‌روزرسانی شد.',
            'user-not-manageable' => 'نمی‌توانید کاربری را که نقش او مجوزهایی دارد که خودتان ندارید تغییر دهید.',
        ],
        ...
        'roles' => [
            ...
            'permissions-not-grantable' => 'نمی‌توانید مجوزهایی را که خودتان ندارید اعطا کنید.',
    ...
    'configuration' => [
        'index' => [
            ...
            'cache-management' => [
                ...
                'action-success' => ':action با موفقیت انجام شد.',
                'action-failed' => ':action ناموفق بود. خروجی زیر را بررسی کنید.',
                ...
                'results' => [
                    'clear-all' => 'همه حافظه‌های نهان پاک شدند.',
                    'clear-config' => 'حافظه نهان پیکربندی پاک شد.',
                    'clear-cache' => 'حافظه نهان برنامه پاک شد.',
                    'clear-compiled' => 'فایل‌های کلاس کامپایل‌شده حذف شدند.',
                    'clear-events' => 'حافظه نهان رویدادها پاک شد.',
                    'clear-routes' => 'حافظه نهان مسیرها پاک شد.',
                    'clear-views' => 'نماهای کامپایل‌شده پاک شدند.',
                    'clear-page-cache' => 'حافظه نهان صفحات پاک شد. هر صفحه فروشگاه در بازدید بعدی دوباره ساخته می‌شود.',
                    'build-all' => 'همه حافظه‌های نهان بازسازی شدند.',
                    'build-config' => 'حافظه نهان پیکربندی ساخته شد.',
                    'build-routes' => 'حافظه نهان مسیرها ساخته شد.',
                    'build-views' => 'نماها کامپایل شدند.',
                ],
                ...
                'actions' => [
                    ...
                    'clear-page-cache' => 'پاک کردن حافظه نهان صفحات',
                ...
                'full-page-cache' => [
                    ...
                    'settings' => [
                        ...
                        'flush' => 'پاک‌سازی حافظه نهان صفحات',
                        'flush-info' => 'حافظه نهان صفحات را خالی کنید تا هر صفحه فروشگاه در بازدید بعدی دوباره ساخته شود.',
                    ],
                ],
            ],
        ],
