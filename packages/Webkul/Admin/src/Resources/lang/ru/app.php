...
return [
            ...
            'create' => [
                ...
                'cart' => [
                    ...
                    'address' => [
                        ...
                        'address-updated-payment-info' => 'Способы оплаты и итоговые суммы заказа будут обновлены для измененного адреса. Нажмите «Продолжить», чтобы загрузить актуальные варианты.',
                        'address-updated-shipping-info' => 'Способы и стоимость доставки будут пересчитаны для измененного адреса. Нажмите «Продолжить», чтобы загрузить актуальные варианты.',
                        'address-updated-title' => 'Адрес обновлен',
                        'addresses' => 'Адреса',
                        'back' => 'Назад',
    ...
    'marketing' => [
        ...
        'promotions' => [
            ...
            'catalog-rules' => [
                ...
                'queue-note' => 'Сохранение этого правила обновляет цену каждого товара, к которому оно применяется. Если оно применяется ко многим товарам, используйте драйвер очереди database или redis с запущенным обработчиком очереди, чтобы цены обновлялись в фоновом режиме, а не замедляли сохранение.',
    ...
    'appearance' => [
        ...
        'sections' => [
            'index' => [
                ...
                'inactive-theme' => 'Настроить можно только тему, активную на канале.',
                'locale' => 'Локаль',
                'mobile' => 'Телефон',
                'no-fields' => 'У этого раздела нет настроек для редактирования в этой теме.',
                'no-types' => 'Эта тема не предлагает типов разделов для добавления.',
            ...
            'create' => [
                ...
                'singleton-exists' => 'Этот канал показывает только один раздел «:type».',
    ...
    'settings' => [
        ...
        'users' => [
            ...
            'role-not-grantable' => 'Вы не можете назначить роль с правами, которых у вас нет.',
            'update-success' => 'Пользователь успешно обновлен.',
            'user-not-manageable' => 'Вы не можете изменить пользователя, роль которого имеет права, которых у вас нет.',
        ],
        ...
        'roles' => [
            ...
            'permissions-not-grantable' => 'Вы не можете предоставить права, которых у вас нет.',
    ...
    'configuration' => [
        'index' => [
            ...
            'cache-management' => [
                ...
                'action-success' => ':action успешно выполнено.',
                'action-failed' => ':action не выполнено. Проверьте вывод ниже.',
                ...
                'results' => [
                    'clear-all' => 'Все кэши очищены.',
                    'clear-config' => 'Кэш конфигурации очищен.',
                    'clear-cache' => 'Кэш приложения очищен.',
                    'clear-compiled' => 'Скомпилированные файлы классов удалены.',
                    'clear-events' => 'Кэш событий очищен.',
                    'clear-routes' => 'Кэш маршрутов очищен.',
                    'clear-views' => 'Скомпилированные представления очищены.',
                    'clear-page-cache' => 'Кэш страниц очищен. Каждая страница магазина будет создана заново при следующем посещении.',
                    'build-all' => 'Все кэши перестроены.',
                    'build-config' => 'Кэш конфигурации создан.',
                    'build-routes' => 'Кэш маршрутов создан.',
                    'build-views' => 'Представления скомпилированы.',
                ],
                ...
                'actions' => [
                    ...
                    'clear-page-cache' => 'Очистить кэш страниц',
                ...
                'full-page-cache' => [
                    ...
                    'settings' => [
                        ...
                        'flush' => 'Очистить кэш страниц',
                        'flush-info' => 'Очистите кэш страниц, чтобы каждая страница магазина создавалась заново при следующем посещении.',
                    ],
                ],
            ],
        ],
